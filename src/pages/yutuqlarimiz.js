...
render(){
    ...
    return(
        ...
        {/* <div className={style.body}>
           ...
           <Container> <Row>
           {this.state.school!==null?this.state.school.map((item,key)=>{
return(
    <Col lg={4} sm={12} md={6}>
    <div className={style.karta}>
    <div style={{transition:"all 1s"}}>{item.image!==null?<img src={item.image} alt="..."/>:<img src={wins} alt="..."/>}
     <h3>{item.competition}</h3></div>
     <h3 style={{fontSize:'18px', color:'gold'}}>{item.result}</h3>
