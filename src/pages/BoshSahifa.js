            ...
            <ContainerDashboard>
              <div className="yuqori">
                <Container>
                  ...
                  <div
                    className="second"
                    style={{ marginTop: "-65px", right: "140px" }}
                  >
                    <a
                      href={`tel: ${
                        this.state.school !== null
                ...
                <NavbarContainer>
                  ...
                  >
                    <Container fluid style={{ padding: "10px" }}>
                      <Navbar.Brand>
                        <p className="maktabLogo" style={{ cursor: "pointer" }}>
                      ...
                      <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className={style.meauto}>
                          <NavLink
                            ...
                            to={`/${Global.user}`}
                          >
                            <p className={style.navLink}>Bosh sahifa</p>
                          </NavLink>
                          <NavLink
                            style={{ marginLeft: "20px", color: "white" }}
                            to={`/hayot/${Global.user}`}
                          >
                            <p className={style.navLink}>Maktab hayoti</p>
                          </NavLink>
                          <NavLink
                            style={{ marginLeft: "20px", color: "white" }}
                            to={`/qabul/${Global.user}`}
                          >
                            <p className={style.navLink}>Qabul</p>
                          </NavLink>
                          <NavLink
                            style={{ marginLeft: "20px", color: "white" }}
                            to={`/yangiliklar/${Global.user}`}
                          >
                            <p className={style.navLink}>Yangiliklar</p>
                          </NavLink>
                          <NavLink
                            style={{ marginLeft: "20px", color: "white" }}
                            to={`/rahbariyat/${Global.user}`}
                          >
                            <p className={style.navLink}>Maktab ma'muriyati</p>
                          </NavLink>
                          <NavLink
                            style={{ marginLeft: "20px", color: "white" }}
                            to={`/alochilar/${Global.user}`}
                          >
                            <p className={style.navLink}>Maktab alochilari</p>
                          </NavLink>
                        </Nav>
                      </Navbar.Collapse>
                    </Container>
            ...
            <div className={style.containerRow}>
              <Row>
                ...
                <Col xs={12} sm={12} md={8} lg={8} className={style.col}>
                  ...
                  <Link to={`/yangiliklar/${Global.user}`}>
