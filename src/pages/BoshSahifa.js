            ...
            <div>
                {this.state.loader ? (
                    ...
                    <div>
                        {/* <NavBar/> */}
                        <ContainerDashboard>
                            <div className="yuqori" style={{ backgroundColor: "transparent", width: "100vw" }}>
                                <div className="gerbHead" style={{ width: "100%" }}>
                                    <img src={gerb} alt="" />
                                    <p>
                                        {this.state.region !== null ? this.state.region.address : ""}{" "}
                                        {this.state.region !== null ? this.state.region.region_name : ""} tumani{" "}
                                        {this.state.school !== null ? this.state.school.school_number : ""} -{" "}
                        ...
                        <div className="iconsHead">
                            <div>
                                <Tooltip
                                    placement="left"
                                    title={`${
                                        this.state.school !== null ? this.state.school.email : "ittower01@gmail.com"
                                    }`}
                                >
                                    {" "}
                                    <a
                            ...
                            <div>
                                <Tooltip placement="left" title="+998 93 082 03 72">
                                    ...
                                    <a
                                        ...
                                        href={`tel: ${
                                            this.state.school !== null ? this.state.school.phone : "+998 93 082 03 72"
                                        }`}
                                    >
                                        <FontAwesomeIcon
                                            icon={faPhone}
                        ...
                        <div style={{ width: "100vw" }}>
                            <Navbar collapseOnSelect expand="lg" className={style.Navbar}>
                                <Container fluid>
                                    ...
                                    <Navbar.Toggle style={{ backgroundColor: "darkblue", outline: "none" }}>
                                        <i
                                            class="fa fa-bars"
                                            aria-hidden="true"
                    ...
                    > */}
                                        ...
                                        <h3>Yutuqlarimiz</h3>
                                        <p>
                                            Sizda bizning maktabimiz yutuqlari bilan tanishib chiqish uchun qulay
                                            imkoniyat bor
                                        </p>
                                        {/* </Link> */}
                                    </div>
                            ...
                            <Row>
                                <Col xs={12} sm={12} md={4} lg={4} className={style.col}>
                                    ...
                                    <p className={style.pp}>
                                        Maktabimizga virtual sayohat qiling va siz bizning maktabimiz haqida ko'proq
