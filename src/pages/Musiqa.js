...
import sport3 from '../img/musiqa3.jpg'
import sport4 from '../img/musiqa4.jpeg'
import sport5 from '../img/musiqa5.jfif'
import sport6 from '../img/musiqa6.jpg'
...
export default class Musiqa extends Component {
    ...
    state={
        sports:[
            {
                title: "Pionina mashg'uloti",
                day:'Dush-chor-juma',
                time:'12:30 dan 14:30 gacha ',
                location:"1-sport zal",
            },
            {
                title: "Skripka mashg'uloti",
                day:'Sesh-pay-shanba',
                time:'11:30 dan 13:30 gacha ',
                location:"1-sport zal",
            },
            {
                title: "Gitara mashg'uloti",
                day:'Dush-chor-juma',
                    ...
                    <Row>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            ...
                            <div className={styless.card, styless.cardone} style={{borderBottom:'2px solid blue', boxShadow: 'rgba(0, 0, 0, 0.1) 0px 4px 12px'}}>
                                ...
                                <Button className={styless.btncard}>Pioninachi</Button>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            ...
                            <div className={styless.card, styless.cardone} style={{borderBottom:'2px solid blue',boxShadow: 'rgba(0, 0, 0, 0.1) 0px 4px 12px'}}>
                                ...
                                <div className={styless.desc}>
                                <Button className={styless.btncard}>Skripkachi</Button>
                                <p>O'zbekiston Respublikasi chempioni,Yoshlar orasida yetakchi murabbiy</p>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            ...
                            <div className={styless.card, styless.cardone} style={{borderBottom:'2px solid blue',boxShadow: 'rgba(0, 0, 0, 0.1) 0px 4px 12px'}}>
                                ...
                                <div className={styless.desc}>
                                <Button className={styless.btncard}>Gitara ustasi</Button>
                                <p>O'zbekiston Respublikasi chempioni,Yoshlar orasida yetakchi murabbiy</p>
