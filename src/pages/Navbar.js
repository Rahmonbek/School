      ...
      <div>
        <div>
                    ...
                    <Navbar collapseOnSelect expand="lg" className={style.Navbar}>
                        <Container>
                            <Navbar.Brand><span className={style.maktabLogo} style={{ cursor:'pointer', marginTop:'8px', }}><Link to={`/${this.state.id}`} style={{color:'gold', fontSize:"24px",fontWeight:'bold', letterSpacing:'5px' }} >{this.state.school!==null?this.state.school.school_number+' - maktab':"Maktab raqami"}</Link></span></Navbar.Brand>
